...
| | CONTENT-006 | Mậu Thân | Review canonical video "Trước cơn bão" | Thọ | ACTIVE | | [`docs/tasks/active/CONTENT-006.md`](../tasks/active/CONTENT-006.md) | Chưa coi video là canonical, chờ duyệt lại | [`CONTENT-006.md`](../tasks/active/CONTENT-006.md), [`active.md`](../tasks/active/active.md) | Thọ (PO) uỷ quyền Codex hoàn tất Historical/Media review. Chấp thuận Educational Fair-use. Đã đóng Task. |
