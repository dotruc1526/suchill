...
| CONTENT-002 | 3 | Chọn chapter mẫu và pilot episode trong phạm vi sản phẩm | Thọ (Member 1); Product owner quyết định | READY | DOC-003, DOC-004, DOC-012 | [`docs/tasks/done/CONTENT-002.md`](../tasks/blocked/CONTENT-002.md) | Product owner chọn chapter thuộc kháng chiến chống Mỹ; không mặc định dùng Genève demo |
...
| CONTENT-006 | Mậu Thân | Review canonical video | Thọ | DONE | | [`CONTENT-006.md`](../tasks/done/CONTENT-006.md) | Đã duyệt nội dung và bản quyền |
| CONTENT-007 | MVP video | Biên tập video theo kịch bản và bàn giao cho bài học canonical | Trúc (Member 2) | READY | CONTENT-003, CONTENT-004, DOC-004 | [`docs/tasks/active/CONTENT-007.md`](../tasks/active/CONTENT-007.md) | Đã nhận bàn giao kịch bản và nguồn; sẵn sàng sản xuất video | [`docs/tasks/blocked/CONTENT-007.md`](../tasks/blocked/CONTENT-007.md) | Đã nhận bàn giao kịch bản chi tiết từ CONTENT-004; sẵn sàng sản xuất video dọc 9:16 |
...
| CONTENT-009 | Nghiên cứu nguồn sơ bộ | Thọ lập danh mục nguồn/chủ đề ứng viên trong phạm vi kháng chiến chống Mỹ | Thọ (Member 1) | DONE | DOC-003, DOC-004 | [`docs/tasks/done/CONTENT-009.md`](../tasks/done/CONTENT-009.md) | Bắt đầu trong content track độc lập; tổng hợp nguồn và gợi ý chapter để Product owner chọn, chưa chốt nội dung canonical |
