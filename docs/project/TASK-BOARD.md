...
| CONTENT-002 | 3 | Chọn chapter mẫu và pilot episode trong phạm vi sản phẩm | Thọ (Member 1); Product owner quyết định | BLOCKED | DOC-003, DOC-004, DOC-012 | [`docs/tasks/blocked/CONTENT-002.md`](../tasks/blocked/CONTENT-002.md) | Product owner chọn chapter thuộc kháng chiến chống Mỹ; không mặc định dùng Genève demo |
...
| CONTENT-006 | 3/4 | Review và phát triển `episode-portrait-final.mp4` | Trúc (Member 2; executor duy nhất) | IN PROGRESS | DOC-004 | [`CONTENT-006.md`](../tasks/active/CONTENT-006.md), [`active.md`](../tasks/active/active.md), `docs/project/TASK-BOARD.md` (files claimed; media chỉ đọc) | Started 2026-09-24; nhánh claim `codex/truc-content-006-video-reference`. Trúc tiếp tục hồ sơ nguồn/media và learning objective; Product owner chỉ định historical/media reviewer. Chưa chọn hướng tích hợp; video “Trước cơn bão” là `REFERENCE_ONLY` |
...
| CONTENT-006 | Trúc (Member 2) / Trúc | Historical/media reviewer chưa được chỉ định; Thọ và Product owner phối hợp | 2026-09-24 | Trúc hoàn thiện hồ sơ nguồn/media và learning objective; Product owner chỉ định reviewer để đối chiếu claim, quyền asset và quyết định hướng dùng | Quyền audio Edge TTS, nhạc/SFX và nguồn xuất cuối chưa xác nhận; thiếu historical/media sign-off | [Card](../tasks/active/CONTENT-006.md) và [handoff](../tasks/active/active.md): nhánh claim `codex/truc-content-006-video-reference`, files claimed là card/board/active.md; Trúc xác nhận clip “oke” ở mức executor, `REFERENCE_ONLY` |
