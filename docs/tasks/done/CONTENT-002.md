...
- Phase / milestone: Product/content track trước M7
...
- In scope: chọn một chapter mẫu thuộc phạm vi kháng chiến chống Mỹ ở Việt Nam cho MVP và một pilot episode nằm trong chapter đó; nêu mục tiêu học và ranh giới lịch sử để CONTENT-008 lập bản đồ nhiều lesson.
- Out of scope: tự xem Genève demo hoặc ví dụ cũ là nội dung canonical; viết toàn bộ screenplay, dựng video, publish content trước review.
- Files claimed: chưa claim content planning file; Member 1 ghi đường dẫn khi nhận task.
- Shared-contract consumers: CONTENT-003/004/007/008, FE-005/006, QA-005.
...
- Commands/checks: đối chiếu product scope 2026-09-23, Phase 2/3 authoring/source rules và Phase 9 M7-01.
- Expected result: chapter/pilot brief có mục tiêu, scope, owner/reviewer và next action rõ.
