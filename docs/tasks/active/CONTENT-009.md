...
- Executor name: Chưa gán; điền khi claim
...
- [ ] Có danh sách chủ đề ứng viên trong phạm vi sản phẩm, kèm lý do phù hợp một chapter nhiều lesson; không dùng demo Genève làm mặc định.
- [ ] Mỗi nguồn có thông tin truy vết được; tách nguồn gốc, diễn giải và ý tưởng kể chuyện.
- [ ] Những claim chưa chắc chắn hoặc nguồn mâu thuẫn được đánh dấu để historical reviewer kiểm tra.
- [ ] Bản so sánh đủ để Product owner chọn chapter/pilot ở CONTENT-002; chưa gắn trạng thái canonical/approved cho nội dung nghiên cứu.
