...
let c002 = fs.readFileSync('docs/tasks/blocked/CONTENT-002.md', 'utf8');
c002 = c002.replace('> Status: BLOCKED', '> Status: DONE')
           .replace('> Status: READY', '> Status: DONE')
           .replace('Last updated: 2026-09-23', 'Last updated: 2026-09-25')
...
fs.writeFileSync('docs/tasks/blocked/CONTENT-002.md', c002);
